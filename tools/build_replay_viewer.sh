...
image_tag="cogame-cogolf-viewer-build:$$"
container_id=""
cleanup() {
...
# them, not a sample (a missing cogolf_replay.wasm renders as a blank map).
expected=(index.html chrome_common.js replay_doc.js static_replay.js static_replay_worker.js
          broadcast_core.js cogolf_replay.js cogolf_replay.wasm cogolf_replay.data)
missing=()
